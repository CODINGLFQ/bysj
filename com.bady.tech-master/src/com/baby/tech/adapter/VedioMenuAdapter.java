...
public class VedioMenuAdapter extends BaseAdapter {
    ...
    private Integer[] images = {
            // 九宫格图片的设置
    		R.drawable.car_normal, R.drawable.food_btn_normal,
    		R.drawable.threesong_btn, R.drawable.englishsong_btn,
 
            R.drawable.babysong_btn, R.drawable.classicsong_btn,
            R.drawable.kindergartensong_btn,
            
            R.drawable.car_normal,R.drawable.babysong_btn,
            R.drawable.food_btn_normal,
            R.drawable.threesong_btn,
            R.drawable.kindergartensong_btn,
            R.drawable.food_btn_normal,
             R.drawable.threesong_btn,
            R.drawable.kindergartensong_btn,
            R.drawable.babysong_btn, 
            R.drawable.car_normal,
            R.drawable.babysong_btn, R.drawable.threesong_btn,
            R.drawable.kindergartensong_btn,
            R.drawable.car_normal, R.drawable.threesong_btn,
            R.drawable.kindergartensong_btn,
//          R.drawable.car_normal,
//          R.drawable.food_btn_normal,
    };
